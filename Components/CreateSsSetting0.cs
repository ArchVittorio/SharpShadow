...
{
    public class CreateSsSettingsComponent0 : GH_Component
    {
        /*
        static void CreateSsSettings()
        {
            System.Diagnostics.Debug.WriteLine("CreateSsSettings static constructor called.");
        }

        */


        public CreateSsSettingsComponent0()
        ...
        public override Guid ComponentGuid => new Guid("a1b2c3d4-e5f6-7890-abcd-1234567890ef");
    }
}